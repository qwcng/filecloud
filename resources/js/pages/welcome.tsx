            ...
            <div className="flex min-h-screen flex-col items-center bg-[#FDFDFC] p-6 text-[#1b1b18] lg:justify-center lg:p-8 dark:bg-[#0a0a0a]">
                ...
                <div className="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                        ...
                        <div className=" bg-[url('logo.png')] flex-1 rounded-br-lg rounded-bl-lg bg-white p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-tl-lg lg:rounded-br-none lg:p-20 dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
                            <h1 className="mb-1 font-medium text-2xl">Witaj w FILECLOUD</h1>
                            <p className="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                                Twoje kompleksowe rozwiązanie do zarządzania i udostępniania plików.
                            </p>
                            {/* <img src="logo.png" alt="FileCloud" className="mt-4" /> */}
                            <a href="/addFile" className="mt-4 inline-block rounded bg-blue-500 px-4 py-2 text-white">
                                Rozpocznij teraz
                            </a>
                            <p className="mt-4 text-sm text-[#706f6c] dark:text-[#A1A09A]">
                                Masz już konto? <a href={'/login'} className="font-medium text-[#f53003] underline underline-offset-4 dark:text-[#FF4433]">Zaloguj się</a>
                            </p>
                        ...
                        <div className="relative -mb-px aspect-[335/376] w-full shrink-0 overflow-hidden rounded-t-lg bg-[#fff2f2] lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg dark:bg-[#1D0002]">
                            ...
                            >
                                ...
                                <g
                        //            0 duration- starting:translate-y-4 starting:opacity-0"
                        //         >
                        //             <path
                        ...
                        <p>Your one-stop solution for file management and sharing.</p>
                        <a href="/addFile" className="mt-4 inline-block rounded bg-blue-500 px-4 py-2 text-white">
                            Get Started
                        </a>
                         */}
